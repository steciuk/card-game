...
function logMessageAndObject(logType: string, message: string, obj: object) {
	console.log('logMessageAndObject');
	logFile.write(
		util.format(
...
function logMessage(logType: string, message: string) {
...
function logObject(logType: string, obj: any) {
